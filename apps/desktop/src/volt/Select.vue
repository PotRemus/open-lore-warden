<template>
    ...
    >
        ...
        <template #filtericon>
            <span class="material-symbols-outlined text-surface-400 text-[18px]">search</span>
        </template>
        <template #clearicon="{ clearCallback }">
            <span
                class="material-symbols-outlined text-surface-400 absolute top-1/2 -mt-2 inset-e-10 text-[18px]"
                @click="clearCallback"
            >close</span>
        </template>
